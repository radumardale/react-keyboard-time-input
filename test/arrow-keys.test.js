...
describe('up', function () {
  ...
  it('should increment 2x more when shift key is pressed', function () {
    expect(arrow('00:00:00:000', 0, true, true).input.value).toEqual('02:00:00:000')
    expect(arrow('00:15:00:000', 3, true, true).input.value).toEqual('00:17:00:000')
    expect(arrow('00:00:40:000', 6, true, true).input.value).toEqual('00:00:42:000')
    expect(arrow('00:00:00:100', 9, true, true).input.value).toEqual('00:00:00:102')
  })
  it('should increment 4x more when shift key is pressed', function () {
    expect(arrow('00:00:00:100', 9, true, true, true).input.value).toEqual('00:00:00:104')
  })
  it('should toggle AM/PM when carat is over AM/PM', function () {
    expect(arrow('01:00 AM', 6, true).input.value).toEqual('01:00 PM')
    expect(arrow('01:00:00:000 PM', 13, true).input.value).toEqual('01:00:00:000 AM')
  })
})
...
describe('down', function () {
  ...
  it('should decrement 2x more when shift key is pressed', function () {
    expect(arrow('02:00:00:000', 0, false, true).input.value).toEqual('00:00:00:000')
    expect(arrow('00:17:00:000', 3, false, true).input.value).toEqual('00:15:00:000')
    expect(arrow('00:00:42:000', 6, false, true).input.value).toEqual('00:00:40:000')
    expect(arrow('00:00:00:102', 9, false, true).input.value).toEqual('00:00:00:100')
  })
  it('should decrement 4x more when shift and meta keys are pressed', function () {
    expect(arrow('00:00:00:104', 9, false, true, true).input.value).toEqual('00:00:00:100')
  })
  it('should toggle AM/PM when carat is over AM/PM', function () {
    expect(arrow('01:00 AM', 6, false).input.value).toEqual('01:00 PM')
    expect(arrow('01:00:00:000 PM', 13, false).input.value).toEqual('01:00:00:000 AM')
  })
})
